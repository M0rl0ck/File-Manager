...
`$ git clone https://github.com/M0rl0ck/File-Manager.git`
...
`cp`, `mv` take a path to the **_directory_** as the second parameter.

`compress` and `decompress` take a path to the **_new file with extension_** as the second parameter.
